import {color, changeColorScheme} from "./scheme.js";

let dark_header = document.createElement("div");

dark_header.innerHTML = `
<section class='text-gray-400 bg-gray-900 body-font overflow-hidden'>
    <div class='container px-5 py-24 mx-auto'>
        <div class='flex flex-col text-center w-full mb-20'>
            ...
            <div class='flex mx-auto border-2 border-${color}-500 rounded overflow-hidden mt-6'>
                <button class='py-1 px-4 bg-${color}-500 text-white focus:outline-none'>Monthly</button>
        ...
        <div class='flex flex-wrap -m-4'>
            ...
            <div class='p-4 xl:w-1/4 md:w-1/2 w-full'>
                <div class='h-full p-6 rounded-lg border-2 border-${color}-500 flex flex-col relative overflow-hidden'>
                    <span class='bg-${color}-500 text-white px-3 py-1 tracking-widest text-xs absolute right-0 top-0 rounded-bl'>POPULAR</span>
                    ...
                    <button class='flex items-center mt-auto text-white bg-${color}-500 border-0 py-2 px-4 w-full focus:outline-none hover:bg-${color}-600 rounded'>
                        Button
                        <svg fill='none' stroke='currentColor' stroke-linecap='round' stroke-linejoin='round' stroke-width='2' class='w-4 h-4 ml-auto' viewBox='0 0 24 24'>
                            <path d='M5 12h14M12 5l7 7-7 7'></path>
                        </svg>
...
document.getElementById("content").replaceWith(dark_header);
